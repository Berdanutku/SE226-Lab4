...
mergedDictionary = {}
mergedDictionary.update(dictionary1)
print(mergedDictionary)
del mergedDictionary["Nat"]
print(mergedDictionary)
sort = sorted(mergedDictionary.items())
print(sort)
maxvalue = max(mergedDictionary.values())
minvalue = min(mergedDictionary.values())
